...
arcade.draw_circle_outline(face_x + 0, face_y + 0, 200, open_color.black, 4)

#(x,y,width,height,color)
arcade.draw_ellipse_filled(face_x - 50, face_y + 50, 25, 40, open_color.black)
arcade.draw_ellipse_filled(face_x + 50, face_y + 50, 25, 40, open_color.black)
arcade.draw_circle_filled(face_x - 40, face_y + 60, 3, open_color.gray_2)
