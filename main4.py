...
for x in range(100,800,150):
        ...
        for y in range(100,600,150):
                face_x,face_y = (x,y)
                smile_x,smile_y = (face_x + 0,face_y - 50)
                eye1_x,eye1_y = (face_x - 50,face_y + 50) 
                eye2_x,eye2_y = (face_x + 50,face_y + 50)
                catch1_x,catch1_y = (face_x - 40,face_y + 60) 
                catch2_x,catch2_y = (face_x + 60,face_y + 60) 
                ...
                arcade.draw_ellipse_filled(eye1_x,eye1_y,25,40,open_color.black)
                arcade.draw_ellipse_filled(eye2_x,eye2_y,25,40,open_color.black)
